...
VALUES ('Mountain Condo', 'description', 'img@google.com','img.jpeg', 75, 50, 3, 2, 'Canada', 'Charing', 'Ottawa', 'ON', 'K2G4G3', true),
('Valley Condo', 'description', 'img@google.com', 'img.jpeg', 50, 20, 1, 1, 'Canada', 'Fort', 'Montreal', 'QC', 'K2F4H3', true),
('Suburb Mansion', 'description', 'img@google.com', 'img.jpeg', 1000, 100, 3, 5, 'Canada', 'Chartwell', 'Toronto', 'ON', 'K7D5G7', false);
